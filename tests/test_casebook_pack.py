"""Regression checks for the nexus-dev-graph-map casebook."""
...
from casebook.harness import assert_expected, nexus_dev_graph_map_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_dev_graph_map_summary(), assert_expected())
