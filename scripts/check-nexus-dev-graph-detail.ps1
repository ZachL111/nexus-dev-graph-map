...
$repo = "nexus-dev-graph-map"
$language = "Rust"
$category = "Developer tools"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/nexus-dev-graph-walkthrough.md")) {
